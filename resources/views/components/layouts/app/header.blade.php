...
<header class="bg-white dark:bg-gray-800 shadow-sm z-20 border-b border-gray-200 dark:border-gray-700">
    <div class="flex items-center justify-between h-16 px-4">
        ...
        <div class="flex items-center">  <a href="/admin" class="ml-4 block">
                <img src="/images/poza2.webp"
                     alt="{{ config('app.name') }}"
                     class="w-8 h-8 object-contain rounded-lg hover:opacity-80 transition-all duration-200">
            </a>
